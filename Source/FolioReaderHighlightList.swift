...
class FolioReaderHighlightList: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.backgroundColor = self.folioReader.isNight(self.readerConfig.nightModeMenuBackground, self.readerConfig.menuBackgroundColor, self.readerConfig.goldModeMenuBackground)
        self.tableView.separatorColor = self.folioReader.isNight(self.readerConfig.nightModeSeparatorColor, self.readerConfig.menuSeparatorColor, self.readerConfig.goldModeSeparatorColor)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        dateLabel.textColor = self.folioReader.isNight(UIColor(white: 5, alpha: 0.3), UIColor.lightGray, UIColor.lightGray)
        ...
        let textColor = self.folioReader.isNight(self.readerConfig.menuTextColor, UIColor.black, UIColor.black)
        ...
        if (highlight.type == HighlightStyle.underline.rawValue) {
            ...
            text.addAttribute(NSAttributedString.Key.underlineColor, value: HighlightStyle.colorForStyle(highlight.type, readMode: self.folioReader.readMode), range: range)
            ...
            text.addAttribute(NSAttributedString.Key.backgroundColor, value: HighlightStyle.colorForStyle(highlight.type, readMode: self.folioReader.readMode), range: range)
        }
